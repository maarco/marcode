...
- [Install Marcode](./user/install.md)
...
- [Unified workspace sidebar](./user/unified-workspace-sidebar.md)
...
- [Project workspace layout](./internals/project-workspace-layout.md)
...
- [Marcode Connect setup](./operations/connect-setup.md)
