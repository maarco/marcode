...
Connect a phone, browser, or another desktop app to Marcode running on a different
...
**SSH**, and enter a host or SSH alias such as `user@example.com`. Marcode starts
...
the connection stops a server that Marcode launched; a server that was already
...
| Error                                                     | Recovery                                                                                                                                    |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `environment_link_limit_exceeded` or managed tunnel limit | Deregister an unused environment, then restart Marcode on the host.                                                                         |
...
| Expired or invalid link proof                             | Check the host's date and time, update Marcode, then restart it.                                                                            |
...
devices. For server version warnings, follow [Updating Marcode](./updating.md).
