...
### Deregister a Marcode Connect Environment

Open your account menu and choose **Marcode Connect** to see every environment registered to your
account. On mobile, open **Settings** → **Marcode Connect**. Choose **Deregister** to revoke an
environment's Marcode Connect access, remove any managed tunnel, and free its host space.
