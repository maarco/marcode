...
const guardedMobileFile = createOxlintRuleHarness(
  "marcode/no-mobile-uniwind-theme-escape-hatches",
  {
...
const webFile = createOxlintRuleHarness("marcode/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/web/src/ThemeSurface.tsx",
});

describe("marcode/no-mobile-uniwind-theme-escape-hatches", () => {
