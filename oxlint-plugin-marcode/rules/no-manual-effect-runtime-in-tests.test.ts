...
const rule = createOxlintRuleHarness("marcode/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("marcode/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("marcode/no-manual-effect-runtime-in-tests");
