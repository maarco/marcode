...
Works with your subscriptions on Claude Code, Codex, Cursor, Grok Build, OpenCode, and Google Antigravity. If they're set up on your computer, Marcode can control them.

## "Wait, what are you selling me?"

Nothing. Marcode is a maintained fork of [T3 Code](https://github.com/pingdotgg/t3code), built for the
best possible development experience with agents. If it ever goes the wrong direction, you have
everything you need to fork it and build the editor that you want.

## Installation

> [!WARNING]
> Marcode currently supports Codex, Claude, Cursor, Grok Build, OpenCode, and Antigravity. Install and authenticate at least one provider before use:
>
