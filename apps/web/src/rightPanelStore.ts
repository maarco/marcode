...
// ── Marcode fork seam ── upstream also imports ChatFileAttachment here for its
// right-panel file/attachment surface. Marcode retired that surface: the
// floating Code editor owns file editing (see marcodeRightPanelPolicy.ts).
 ...
 *
 * The storage key, storage version and `isPullRequestsPanelKey` that upstream
 * keeps beside this live in `marcodeRightPanelPolicy.ts` instead.
 */
