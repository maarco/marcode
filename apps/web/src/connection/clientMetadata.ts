...
/**
 * ── Marcode fork seam ──
 * Upstream hardcodes "T3 Code Desktop"/"T3 Code Web" here. These labels are
 * user-visible in Settings → Connections, so they come from Marcode branding
 * (`APP_BASE_NAME`, which the desktop shell can override per channel). The
 * OS/device/browser detection below is upstream's and stays as-is.
 */
