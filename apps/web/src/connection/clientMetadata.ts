...
// ── Marcode fork seam ──
// Upstream hardcodes the product name in the two labels below. They are
// user-visible in the connections list, so Marcode sources them from the
// product identity in ../branding instead. Keep this import: a sync that drops
// it silently relabels every connected client with the upstream name.
