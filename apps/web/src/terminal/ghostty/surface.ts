...
/**
 * Applies one terminal output update to a surface. Marcode's drawer renders
 * through xterm, so this lives with the Ghostty surface it belongs to rather
 * than in ThreadTerminalDrawer, where upstream keeps it.
 */
