...
export function openDiffFilePrimaryAction({
  ...
  // Upstream added this rebase: a diff path is repository-relative, while the
  // project (and therefore the editor tab) is rooted at the workspace. Marcode
  // keeps that resolution and routes the result at the floating editor rather
  // than the retired right-panel file surface.
