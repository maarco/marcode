        ...
        {state.releaseNotes.map((releaseNote, index) => {
          ...
          return (
            <div key={releaseNote.version}>
              ...
              <section>
                {/* Marcode fork seam: the fork's type scale uses medium, not
                    semibold, for this heading. Upstream extracted the block out
                    of SidebarUpdatePill in #9138; the weight follows it here. */}
