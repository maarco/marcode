...
function renderTabs(first: DesktopPreviewFavicon | null, second?: DesktopPreviewFavicon) {
  return renderToStaticMarkup(
    // No onCopyFilePath / onAddFiles / filesAvailable: Marcode retired the
    // right-panel file and files surfaces, so RightPanelTabsProps has no such
    // members for upstream's fixture to fill.
    <RightPanelTabs
      mode="inline"
