...
const resolveOptions = (platform: string, availableEditors: ReadonlyArray<EditorId>) => {
  const baseOptions: ReadonlyArray<Omit<OpenInOption, "label">> = [
    ...
    },
    {
      ...
      // upstream uses here (`FolderClosedIcon`) reads thinner than every glyph
      // beside it. `FolderOpenFilled`, not `FolderFilled` — that one is the
      // workspace Files panel, and these two must not look like the same action.
