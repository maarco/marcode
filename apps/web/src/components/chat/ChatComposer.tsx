      ...
      <div className="relative">
        ...
        >
          <div
            ...
            className={cn(
              // Marcode fork seam: borderless by default — the glass surface +
              // shadow carry the edge. Drag-over still draws one, since that's
              // the only cue the drop is live (upstream uses a ring instead).
