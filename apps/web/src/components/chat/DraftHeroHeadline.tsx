...
export function DraftHeroHeadline({
  ...
  const projectSelector = shouldShowProjectMenu ? (
    <Menu>
      {/* Upstream's migration off the native `title` attribute (the new
          marcode/no-native-title-tooltip rule), keeping Marcode's GIF-aware
          headline text treatment on the trigger. */}
      <Tooltip>
        <TooltipTrigger
          render={
            <MenuTrigger
