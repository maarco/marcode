...
// brand + sidebar toggle live in the floating pill nav now; electron keeps a bare
// drag strip so macOS traffic lights don't overlap the projects header
...
// settings lives in the floating pill nav now — the footer only carries update pills
          ...
          <div className="flex items-center gap-1">
            <Tooltip>
              ...
              <TooltipPopup side="right">
                Search{commandPaletteShortcutLabel ? ` (${commandPaletteShortcutLabel})` : ""}
              </TooltipPopup>
            </Tooltip>
            <ProjectSortMenu
