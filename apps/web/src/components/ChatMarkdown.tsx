...
// ── Marcode fork seam ──
// Upstream also imports `useRightPanelStore` here to open a file in the
// right-panel `file` surface. Marcode retired that surface; file links land in
// the floating editor via `openFileInFloatingEditor` above.
