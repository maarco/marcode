...
function ChatMarkdown({
  ...
  // ── Marcode fork seam ──
  // Upstream opens the resolved path in the right panel's file surface. Marcode retired that
  // surface, so the same lookup feeds the floating editor instead. MarkdownFileLink only calls
  // this when it has a workspacePath, which is this cwd.
