...
// ── Marcode fork seam ──
// Upstream also imports `useRightPanelStore` here to open files in the
// right-panel `file` surface. Marcode retired that surface — the floating Code
// editor owns file editing — so `openFileInFloatingEditor` above replaces it.
