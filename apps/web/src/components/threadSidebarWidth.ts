...
// Exported for threadSidebarWidth.test.ts, the Marcode-owned pin that also
// asserts the sidebar header carries no brand. Upstream un-exported this when
// they deleted their copy of that test.
