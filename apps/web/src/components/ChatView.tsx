...
function ChatViewContent(props: ChatViewProps) {
  ...
  // `handleNewThread` is already declared below in Marcode's ordering.
            ...
            >
              ...
              >
                <div className="group/composer-stack pointer-events-auto relative z-10">
                  ...
                  >
                    {/* ── Marcode fork seam ──
                        Upstream's ComposerSurface owns the glass geometry; Marcode
                        only lowers the surface tint. `chat-composer-glass-shell-transparent`
                        sets --glass-opacity, which Shell/Host/Main already read, so
                        the fork keeps one class instead of a parallel shell. */}
