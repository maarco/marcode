  ...
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      >
        ...
        >
          {/* Marcode fork seam: upstream renders the thread action cluster and the
              panel layout controls inside ChatHeader. Marcode's header keeps only the
              title; the cluster is portaled into FloatingPillNav below and
              panelLayoutControls is rendered once by the workspace shell above. */}
