...
function ChatViewContent(props: ChatViewProps) {
  ...
  // only the maximize control remains, shown while the panel is open. Upstream's
  // `.workspace-titlebar-controls` utility is gone — their shared-inset fix
  // (#6592) moved the positioning inline and keys the theme rules off the
  // `data-workspace-titlebar-controls` attribute instead.
