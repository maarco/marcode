...
function ChatViewContent(props: ChatViewProps) {
  ...
  // Upstream's cmd+enter background draft (pingdotgg/t3code#7821) needs this
  // handler. It arrived in a hunk Marcode had restructured for the pill-nav
  // header, so it merges cleanly into a ChatView that never declared it.
  ...
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      >
        ...
        >
          {/* Marcode fork seam: the thread title is the whole header here. The
              action cluster is portaled into FloatingPillNav below, and thread
              actions live on the sidebar row's context menu, so upstream's
              breadcrumb/rename/menu props are deliberately not threaded in. */}
