  ...
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      >
        ...
        >
          {/* ── Marcode fork seam ──────────────────────────────────────────
              Upstream renders panelLayoutControls here while the right panel is
              closed, and passes the full thread-action prop set to ChatHeader.
              Marcode's panelLayoutControls only exists while the panel is open
              and renders on the column container above, and the thread actions
              are portaled into FloatingPillNav below, so this header carries
              the title alone. */}
