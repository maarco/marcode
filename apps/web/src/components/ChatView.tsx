                ...
                <div className="group/composer-stack pointer-events-auto relative z-10">
                  {isDraftHeroState ? (
                    <div className="relative z-0 w-full">
                      {/* ── Marcode fork seam ── */}
                      {/* Marcode keeps its own horizontal insets and the larger sm
                          bottom gap. Upstream's #8090 shoulder-tab reduction is
                          repeated at sm because `sm:pb-10` would otherwise shadow
                          the unprefixed rule at every desktop width. */}
                      <div
                        className="px-4 pb-8 sm:px-6 sm:pb-10 group-has-[.chat-composer-shoulder-tab]/composer-stack:pb-4 sm:group-has-[.chat-composer-shoulder-tab]/composer-stack:pb-6"
                        style={
