...
function ChatViewContent(props: ChatViewProps) {
  ...
  // No `activeFileSurface` here on purpose: Marcode retired the right-panel `file`/`files`
  // surfaces, and the floating Code editor owns file editing. See apps/web/src/editor/.
