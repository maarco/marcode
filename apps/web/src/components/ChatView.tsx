  ...
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      >
        ...
        >
          {/* ── Marcode fork seam ──
              Upstream's ChatHeader owns the thread action cluster, the panel
              layout controls, and the PR-driven thread action menu. Marcode
              renders only the title here and portals ThreadActionsCluster into
              FloatingPillNav (below), while panelLayoutControls is mounted once
              at the workspace root. Upstream's changeRequestState → changeRequest
              rename lands in the settle memos above, not on this element. */}
