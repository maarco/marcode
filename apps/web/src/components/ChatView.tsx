...
function ChatViewContent(props: ChatViewProps) {
  ...
  // ── Marcode fork seam ──
  // Upstream previews a browser-openable attachment in a right-panel `file`
  // surface. Marcode retired that surface — the floating Code editor owns file
  // editing — and has no attachment preview host, so every attachment takes the
  // download path here.
