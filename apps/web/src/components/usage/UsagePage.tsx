  ...
  return (
    <SidebarInset className="h-dvh min-h-0 overflow-hidden overscroll-y-none bg-background text-foreground isolate">
      <div className="flex min-h-0 min-w-0 flex-1 flex-col bg-background text-foreground">
        {/* Marcode renders no sidebar here, so the titlebar needs the
            unconditional inset (see workspaceTitlebar.fork.test.ts). */}
        <WorkspacePageHeader electron={isElectron} sidebarless>
          {topbarContent}
        </WorkspacePageHeader>
