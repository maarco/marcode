...
function PullRequestRefreshControl({
  ...
  return (
    // Marcode fork seam: upstream renders a bare button. Marcode keeps every
    // icon-only header control tooltipped, so the tooltip lives with the
    // control instead of at each call site.
    <Tooltip>
      <TooltipTrigger
        render={
          <Button
