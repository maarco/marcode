...
function PullRequestRefreshControl({
  ...
  // Marcode fork seam: icon-only controls carry a styled Tooltip. Upstream
  // extracted this control without one; keeping the tooltip here covers both
  // the condensed topbar and the in-flow call site from a single producer.
  return (
    <Tooltip>
      <TooltipTrigger
        render={
