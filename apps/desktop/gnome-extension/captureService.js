...
// ── Marcode fork seam ── upstream allows com.t3tools.T3Code(.Development).SnapShot.
// LinuxSnapShot requests `${appId}.SnapShot`, and appId is
// DesktopEnvironment.linuxDesktopEntryName minus ".desktop" — "marcode" here.
// Leaving upstream's names would make the extension refuse every request.
