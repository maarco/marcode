...
// Exported so `bootService.test.ts` can pin that the unit Marcode installs is
// `marcode.service`. The variable name itself stays upstream-shaped: it is a
// compatibility identifier read by the service launcher.
