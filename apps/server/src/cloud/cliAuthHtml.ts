...
declare const __MARCODE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __MARCODE_BUILD_CHANNEL__ === "undefined" ? "dev" : __MARCODE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Marcode (Dev)",
  nightly: "Marcode (Nightly)",
  latest: "Marcode",
