...
const TEST_ENV = {
  MARCODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  MARCODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  MARCODE_HOSTED_APP_URL: "https://hosted.example.test",
};
