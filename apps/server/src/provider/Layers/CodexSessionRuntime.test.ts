...
describe("buildCodexDeveloperInstructions", () => {
  it("appends runtime info after the mode instructions", () => {
    ...
    // Marcode fork seam: upstream asserts /T3 Code/. The developer instructions carry
    // Marcode's product identity, so this pin must fail if a sync reverts the branding.
    NodeAssert.match(instructions, /Marcode/);
