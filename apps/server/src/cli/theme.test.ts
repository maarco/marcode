...
describe("t3 theme", () => {
  ...
  // ── Marcode fork seam ──
  // Upstream's version of this test asserts T3CODE_HOME. Marcode's CLI base-dir
  // variable is MARCODE_HOME, so a sync that reinstates the upstream name must
  // fail here rather than shipping a `t3 theme` that ignores the user's home.
