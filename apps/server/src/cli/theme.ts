...
// everywhere else in this CLI (see cli/config.ts, cli/pair.ts, cli/triage.ts).
// Keeping the upstream name would make this one command silently target the
// default install for anyone who exports MARCODE_HOME.
