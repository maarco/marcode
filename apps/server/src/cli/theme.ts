...
// Marcode fork seam: upstream reads T3CODE_HOME; this CLI's base-dir
// variable is MARCODE_HOME everywhere (see cli/config.ts and cli/pair.ts).
const envT3Home = Config.string("MARCODE_HOME").pipe(Config.option);
