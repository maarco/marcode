...
const status = {
  ...
  logPath: "/home/me/.marcode/userdata/logs/boot-service.log",
} as const;
...
it("reports the installed service version and host paths", () => {
  assert.equal(
    ...
    [
      ...
      "  Unit: /home/me/.config/systemd/user/marcode.service",
      "  Logs: /home/me/.marcode/userdata/logs/boot-service.log",
    ].join("\n"),
  );
});
