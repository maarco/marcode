        ...
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              ...
              source_project: {
                path_with_namespace: "octocat/marcode",
              },
            }),
          ),
        ),
  ...
  it.effect("reads repository clone URLs", () =>
    Effect.gen(function* () {
      mockedRun.mockReturnValueOnce(
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              path_with_namespace: "octocat/marcode",
              web_url: "https://gitlab.com/octocat/marcode",
              http_url_to_repo: "https://gitlab.com/octocat/marcode.git",
              ssh_url_to_repo: "git@gitlab.com:octocat/marcode.git",
            }),
          ),
        ),
      );
      ...
      assert.deepStrictEqual(result, {
        ...
        url: "https://gitlab.com/octocat/marcode",
        sshUrl: "git@gitlab.com:octocat/marcode.git",
      });
    }),
  );
