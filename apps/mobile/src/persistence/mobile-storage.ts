...
const CONNECTIONS_KEY = "marcode.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "marcode.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "marcode.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "marcode.recent-thread-shortcuts";
