...
export function CompactBrandTitle(
  ...
  return (
    ...
    >
      ...
      {/* Marcode keeps the stage pill conditional (production ships no label);
          the styling follows upstream's uniwind migration off useThemeColor,
          which their no-mobile-uniwind-theme-escape-hatches rule now bans. */}
      {stageLabel ? (
