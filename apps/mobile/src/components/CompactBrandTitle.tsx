 ...
 *
 * ── Marcode fork seam ──
 * Upstream renders its own wordmark and always shows a stage pill. Marcode
 * substitutes `MarcodeMark` and hides the pill on the production channel,
 * where `resolveMobileStageLabel` returns null. Everything else follows
 * upstream, including the Uniwind semantic classes.
 */
export function CompactBrandTitle(
  ...
  return (
    <View
      aria-level={1}
      accessibilityLabel="Marcode, Threads"
      accessible
      role="heading"
