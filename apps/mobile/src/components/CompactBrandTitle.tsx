...
export function CompactBrandTitle(
  ...
  return (
    ...
    >
      ...
      {/* ── Marcode fork seam ──
          Upstream always has a stage label ("Alpha" in production) and renders the
          pill unconditionally. Marcode's production label is empty, so the pill is
          conditional here — dropping this guard ships an empty badge in release. */}
      {stageLabel ? (
