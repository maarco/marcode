...
export function CompactBrandTitle(
  ...
  return (
    ...
    >
      ...
      {/* Marcode only renders the stage pill off production; upstream renders it
          unconditionally. Styling follows upstream's semantic Uniwind classes —
          `useThemeColor` is gone and `no-mobile-uniwind-theme-escape-hatches`
          now bans it. */}
      {stageLabel ? (
