...
export function CompactBrandTitle(
  ...
  return (
    ...
    >
      {/* ── Marcode fork seam ── */}
      {/* Marcode's mark is a fixed black-on-white rounded square shared with */}
      {/* apps/web MarcodeMark and favicon.svg, so it takes no theme class. */}
      {/* Upstream renders a themed T3Wordmark here. */}
      ...
      {/* Marcode hides the stage pill on production builds; upstream always renders it. */}
      {stageLabel ? (
