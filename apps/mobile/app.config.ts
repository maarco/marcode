...
// ── Marcode fork seam ──
// Upstream tints each channel's adaptive background and ships a white glyph.
// Marcode uses the same black mark on a white rounded square on every channel
// (channel identity comes from naming, not artwork), so the background stays
// white and `android-icon-foreground.svg` carries the black Marcode glyph.
const androidAdaptiveBackground = "#ffffff";
...
const DEVELOPMENT_ASSETS = {
  ...
  androidAdaptiveBackgroundColor: androidAdaptiveBackground,
