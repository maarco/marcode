...
const RELEASE_ASSETS = {
  ...
  // ── Marcode fork seam ── Marcode's mark is black on a white rounded square
  // across every channel, so the release foreground and background invert
  // upstream's. The splash icon and the explicit absent background image are
  // upstream's (see #892de47f, #c0cad74b) and apply unchanged.
