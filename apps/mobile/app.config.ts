...
// ── Marcode fork seam ──
// Upstream's fix is kept, but the asset is Marcode's mark scaled into Android's
// adaptive safe zone, not upstream's wordmark. Per-variant background colors stay
// Marcode's brand values. See assets/README.md for how the PNG is derived.
