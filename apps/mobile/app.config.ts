...
const RELEASE_ASSETS = {
  ...
  // Marcode's mark is black on a white rounded square across every channel,
  // so release keeps the Marcode foreground and a white adaptive background
  // where upstream ships a white-on-black mark.
