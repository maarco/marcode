...
const workspaceFiles = [
  ...
  "oxlint-plugin-marcode/package.json",
...
function writeWindowsManifestFixtures(
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Marcode-9.9.9-smoke.0-arm64.exe
    sha512: arm64exe
    size: 126621344
  - url: Marcode-9.9.9-smoke.0-arm64.exe.blockmap
    sha512: arm64blockmap
    size: 152344
path: Marcode-9.9.9-smoke.0-arm64.exe
sha512: arm64exe
releaseDate: '2026-03-08T10:32:14.587Z'
`,
  );
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Marcode-9.9.9-smoke.0-x64.exe
    sha512: x64exe
    size: 132000112
  - url: Marcode-9.9.9-smoke.0-x64.exe.blockmap
    sha512: x64blockmap
    size: 160112
path: Marcode-9.9.9-smoke.0-x64.exe
sha512: x64exe
releaseDate: '2026-03-08T10:36:07.540Z'
`,
  );
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=Marcode Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
  ...
  assertContains(
    ...
    "Marcode-9.9.9-smoke.0-arm64.exe",
    "Merged Windows manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedWindowsManifest,
    "Marcode-9.9.9-smoke.0-x64.exe",
