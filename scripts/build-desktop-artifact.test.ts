// @effect-diagnostics nodeBuiltinImport:off - Static assertions read checked-in DMG
// source files, and Node's glob matcher verifies electron-builder exclusions.
