// @effect-diagnostics nodeBuiltinImport:off - Static assertions read checked-in DMG source files, and tests use Node's glob matcher to verify electron-builder exclusions.
