// @effect-diagnostics nodeBuiltinImport:off - Static assertions read checked-in DMG source
// files, and packaged-archive fixtures compute the sidecar digest with the same Node primitive
// as the builder.
