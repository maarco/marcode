...
const ANDROID_PACKAGE = "com.t3tools.marcode.dev";
const APP_SCHEME = "marcode-dev";
...
const IOS_APP_PATH = NodePath.join(
  MOBILE_ROOT,
  ".showcase/ios-derived-data/Build/Products/Debug-iphonesimulator/MarcodeDev.app",
);
...
async function buildIos(): Promise<string> {
  ...
  await runCommand(
    ...
    [
      "-workspace",
      NodePath.join(MOBILE_ROOT, "ios/MarcodeDev.xcworkspace"),
      "-scheme",
      "MarcodeDev",
      "-configuration",
      "Debug",
