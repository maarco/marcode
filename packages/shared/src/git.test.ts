...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:T3Tools/Marcode.git")).toBe(
      "github.com/t3tools/marcode",
    );
    expect(normalizeGitRemoteUrl("https://github.com/T3Tools/Marcode.git")).toBe(
      "github.com/t3tools/marcode",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/T3Tools/Marcode")).toBe(
      "github.com/t3tools/marcode",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:T3Tools/platform/Marcode.git")).toBe(
      "gitlab.com/t3tools/platform/marcode",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/T3Tools/platform/Marcode.git")).toBe(
      "gitlab.com/t3tools/platform/marcode",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:T3Tools/Marcode.git"),
    ).toBe("T3Tools/Marcode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/T3Tools/Marcode.git"),
    ).toBe("T3Tools/Marcode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("ssh://github.com/T3Tools/Marcode.git"),
    ).toBe("T3Tools/Marcode");
  });
});
