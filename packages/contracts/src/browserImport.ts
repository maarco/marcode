 ...
 * machine into a Marcode browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Marcode profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Marcode Full Disk Access in System Settings → Privacy & Security, then retry.",
